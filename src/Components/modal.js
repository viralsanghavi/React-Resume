...
import { Modal, ModalBody, ModalHeader, ListGroup, ListGroupItem, UncontrolledCollapse, Badge, Card } from 'reactstrap'
    ...
    return (
        ...
        <Modal isOpen={show} toggle={toggle} size="lg" >
            ...
            <ModalBody>
                {
                    ar.map(num => (
                        <ListGroup key={num} id={"toggler".concat(num)} style={{ width: "100%", height: "100%" }}>
                            <div className="justify-content-between" style={{ width: "100%", overflow: "" }}>
                            ...
                            <UncontrolledCollapse toggler={"#toggler".concat(num)}>
                                {data.detail[num] !== undefined ?
                                    (<Card style={{ width: "100%" }}>
                                        <h1 className="text-center detail">
                                            {data.detail[num]}
                                        </h1>
                                    </Card>) : (<div></div>)
                                }
